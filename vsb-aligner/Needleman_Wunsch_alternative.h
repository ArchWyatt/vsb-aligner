...
class Needleman_Wunsch_alternative
{
private:
	string a = "";
	string b = "";
...
public:
	Needleman_Wunsch_alternative(char* aa, char* bb, int gap_score, int match_score, int mismatch_score);
	int CalculateScore(int i, int j);
	~Needleman_Wunsch_alternative();
	int get_first_pos();
	int get_last_pos();
	string get_cigar();
