...
#include "Smith_Waterman_alternative.h"

Smith_Waterman_alternative::Smith_Waterman_alternative(char* a, char* b, int gap_score, int match_score, int mismatch_score)
{
...
int Smith_Waterman_alternative::CalculateScore(int i, int j)
{
	int similarity;
	...
	return max(left_score, max(up_score, diag_score));
}

int Smith_Waterman_alternative::NextMove(int pos_i, int pos_j) {
...
int Smith_Waterman_alternative::get_first_pos() {
	return this->j_min;
}

int Smith_Waterman_alternative::get_last_pos() {
	return this->j_max;
}

string Smith_Waterman_alternative::get_cigar() {
	return this->cigar_final;
}

int Smith_Waterman_alternative::get_cigar_length() {
	return this->cigar_length;
}

int Smith_Waterman_alternative::get_matrix_max_score() {
	return this->matrix_max;
}

int Smith_Waterman_alternative::get_mismatch() {
	return this->mismatch;
}

Smith_Waterman_alternative::~Smith_Waterman_alternative() {
