	...
	*/	
	...
	while (iterator.Current() != NULL){
		...
		while (a_iterator.Current() != NULL) {
			...
			Needleman_Wunsch *test = new Needleman_Wunsch(r->sequence, reference_genome, prog_info.options->gap_score, prog_info.options->match_score, prog_info.options->mismatch_score);
			//Needleman_Wunsch_alternative *test = new Needleman_Wunsch_alternative(r->sequence, reference_genome, prog_info.options->gap_score, prog_info.options->match_score, prog_info.options->mismatch_score);
		...
		while (b_iterator.Current() != NULL) {
			...
			Needleman_Wunsch *test2 = new Needleman_Wunsch(r2->sequence, reference_genome2, prog_info.options->gap_score, prog_info.options->match_score, prog_info.options->mismatch_score);
			//Needleman_Wunsch_alternative *test2 = new Needleman_Wunsch_alternative(r2->sequence, reference_genome2, prog_info.options->gap_score, prog_info.options->match_score, prog_info.options->mismatch_score);
